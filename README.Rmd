...
This example shows how to infer the modulation relation between SIRT7 and NFE2L2 using the TCGA liver cancer dataset. Also, two visualization functions are designed to present the output of `ModReg` package.
